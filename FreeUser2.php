  ...
  <body>
      ...
      <div class="topnav" id="myTopnav">
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-content">
            <a style="color: cadetblue;" href="#">Free User Account</a>
    ...
    <div class="transbox">
      <div class="btn-group">
        ...
        <button class="button" id="but1">Verified your account</button>
        </a>
        <a href="purchase_pro.php">
        <button class="button" id="but2">Upgrade to pro</button>
        </a>
      </div>
      <h1>Hello !</h1>
      <p> 
    ...
    <div id="Overview" class="tabcontent">
      ...
      <div class="container">
        ...
        <div class="yourPlan">
          <h3 style="text-align:center; color: #ddd;">Free User</h3>

          <p style="text-align:center; color: #ddd;">
            You can only view recipes, names and ingredients.<br>
          If you want to watch the method you need to upgrade your plan to it.
          </p>
    ...
    <div id="Plans" class="tabcontent">
      ...
      <div class="AvaPlans">
        ...
        <!-- Pro plans -->
        <div class="containerPlans" id="pro1" style="background-color:#f1f1f1">
          <div class="rowPlans">
            <div class="column-66">
