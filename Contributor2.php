...
<html lang="en">
  ...
  <body>
      ...
      <div class="topnav" id="myTopnav">
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-content">
            <a style="color: cadetblue;" href="#">Contributor</a>
    ...
    <div class="transbox">
      <div class="btn-group">
        <a href="recipewrite.php">
        <button class="button" id="but1">Create a recipe</button>
        </a>
        <a href="join meeting.php">
        <button class="button" id="but2" type="submit">Join a meeting</button>
        </a>
      </div>
      <h1>Hello !</h1>
      <p> 
    ...
    <div id="Overview" class="tabcontent">
      ...
      <div class="container">
        ...
        <div class="yourPlan">
          <h3 style="text-align:center; color: #ddd;">Contributor</h3>

          <p style="text-align:center; color: #ddd;">
            You has the ability to view recipes, ingrediants and to buy recipes uploaded,<br>
            and you can further upload your own recipes to the website for other users to access.
          </p>
    ...
    <div id="Plans" class="tabcontent">
      ...
      <div class="AvaPlans">
        ...
        <div class="containerPlans" style="background-color:#00121b">
          <div class="rowPlans">
            <div class="column-66">
              <h1 class="xlarge-font" style="color: #ddd;"><b>Contributor</b></h1>
              <h1 class="large-font" style="color:MediumSeaGreen;"><b>Current Plan</b></h1>
              <p style="color: #ddd;"><span style="font-size:36px; color: #ddd">Inspiring others by your ideas.</span> Has the ability to view recipes, ingrediants and to buy recipes uploaded. A contributor can further upload his/her own recipes to the website for other users to access</p>
            </div>
          </div>
        </div>
        ...
        <div class="containerPlans" style="background-color:#f1f1f1">
          <div class="rowPlans">
            <div class="column-66">
              <h1 class="xlarge-font"><b>Pro User</b></h1>
              <h1 class="large-font" style="color:red;"><b>What is special?</b></h1>
              <p><span style="font-size:24px">Cook like a pro.</span> Has the privilege of viewing various recipes and the respective ingredients, while also having the ability to buy recipes uploaded onto the website. This user can further access videos of the recipe procedures uploaded</p>
